...
Is a simple VJ tool leveraging OpenGL/GLSL to provide live-editing functions and is meant to be connected to a [Boblight](https://code.google.com/p/boblight/) display of the ["Adalight"](http://www.adafruit.com/product/461) type via a serial port. 
...
Planned features are some audio input facilities, so e.g. the music spectrum can be used in the scripts.
...
If you have problems with custom Baud rates above 230400, try upgrading to Qt 5.4. The issues are fixed there.
